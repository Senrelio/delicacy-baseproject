...
public class BaseCrmContact extends GenericBase implements BaseFactory<BaseCrmContact>, Comparable<BaseCrmContact> 
{


	public static BaseCrmContact newInstance(){
		return new BaseCrmContact();
	}

	@Override
	public BaseCrmContact make(){
	...
	public void cloneCopy(BaseCrmContact __bean){
	...
	@Override
	public int compareTo(BaseCrmContact o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseCrmContact o = (BaseCrmContact)obj;
