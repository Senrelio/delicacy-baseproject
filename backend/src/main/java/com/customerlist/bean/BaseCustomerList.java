...
public class BaseCustomerList extends GenericBase implements BaseFactory<BaseCustomerList>, Comparable<BaseCustomerList> 
{


	public static BaseCustomerList newInstance(){
		return new BaseCustomerList();
	}

	@Override
	public BaseCustomerList make(){
		BaseCustomerList b = new BaseCustomerList();
		return b;
	}
	...
	public final static java.lang.String ALL_CAPTIONS = "客户编码,客户编号,销售线索编码,主体类型,维护人员工编码,客户名称,客户级别(重点客户，普通客户，非优先客户),父级客户编码,行业,省,市,区,最近活动时间,最近跟进员工编码,创建日期,创建人,最近修改日,最近修改人,所属部门编码,是否被锁定,有无工商登记,是否为免打扰客户,最近拜访时间,未拜访天数,详细地址,邮政编码,电话,传真,公司网址,微博,总人数,,备注";
	...
	public java.lang.Integer getAnnualRevenue() {
		return this.__annual_revenue;
	}

	public void setAnnualRevenue( java.lang.Integer value ) {
	...
	public void cloneCopy(BaseCustomerList __bean){
	...
	@Override
	public int compareTo(BaseCustomerList o) {
	...
	public boolean equals(Object obj) {
		...
		final BaseCustomerList o = (BaseCustomerList)obj;
	...
	public java.lang.String toJSONString() {
		...
		if(getAnnualRevenue() != null) sb.append(__wrapNumber(count++, "annualRevenue", getAnnualRevenue()));
	...
	public void setDataFromMap(Map<String, Object> values){
		...
		if((val = values.get("annualRevenue")) != null) setAnnualRevenue(__getInt(val)); 
	...
	protected java.lang.Integer  __annual_revenue ;
