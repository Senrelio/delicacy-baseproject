...
public class CrmContactWithC extends fix.db.dao.CrmContact
{


	public CrmContactWithC() throws java.sql.SQLException { initColumnNames(); }
	...
	private void deleteAndSaveDetailTables() throws java.sql.SQLException {
		...
		crmcontactscustomer.setConditionContactsId("=", getContactId());
		...
		if(getDetailCrmContactsCustomer() != null) {
			...
			for(BaseCrmContactsCustomer __crmcontactscustomer : getDetailCrmContactsCustomer() ) {
				...
				__crmcontactscustomer.setContactsId( getContactId());
				// set find flag
	...
	public List<BaseCrmContactWithC> conditionalLoadExt(String addtional) throws java.sql.SQLException {
		List<BaseCrmContactWithC> result = BaseCrmContactWithC.getBeanList(conditionalLoad(addtional));
		return result;
	}

	public BaseCrmContactWithC generateBaseExt() {
		BaseCrmContactWithC ____result = new BaseCrmContactWithC();
		setDataToBase(____result);
		return ____result;
	}

	public void setDataFromBase(BaseCrmContactWithC __base) {
		super.setDataFromBase(__base);
		setDetailCrmContactsCustomer(__base.getDetailCrmContactsCustomer());
	}

	public void setDataToBase(BaseCrmContactWithC __base) {
