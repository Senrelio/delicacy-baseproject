Ext.define('erp.com.contactlist.view.CrmContactsCustomerEditWindow', {
	extend: 'Ext.window.Window',

	xtype: 'contactlistcrmcontactscustomereditwindow',

	requires: [
		'erp.com.contactlist.controller.CrmContactsCustomerEditController'
	],
